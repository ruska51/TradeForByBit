...
def test_place_protected_exit_spot_sets_trigger_direction(monkeypatch, main_module):
    main = main_module
...
def test_ensure_exit_orders_spot_long_sets_trigger_direction(monkeypatch, main_module):
    main = main_module
...
def test_ensure_exit_orders_spot_short_sets_trigger_direction(monkeypatch, main_module):
    main = main_module
