#!/usr/bin/env python3
"""Проверить последние ордера TRX."""
...
print("="*80)
print("ПОСЛЕДНИЕ ОРДЕРА TRX")
print("="*80)

# Get recent closed orders
try:
    orders = exchange.fetch_closed_orders("TRX/USDT:USDT", limit=10, params={"category": "linear"})

    print(f"\nНайдено {len(orders)} ордеров:")
    ...
    for order in orders:
        ...
        if order.get('id') == '59a78158-b61c-41cb-8c74-c5a576b0a4bf':
            print("  [!!!] ЭТО НАШ ОРДЕР НА ЗАКРЫТИЕ!")
